...
- [ ] **Task 1: Prisma schema — add CompanyProfile**
...
- [ ] **Task 7: EnrichmentModule + EnrichmentService**
...
- [ ] **Task 8: EnrichmentController + AppModule**
...
- [ ] **Task 9: Auto-enqueue on job create + GET /jobs/:id includes companyProfile**
